    ...
    if (isset($_SESSION["cart_item"])) {
        ...
        ?>
                ...
                if (!empty($discountPrice) && $total_price > $discountPrice) {
                    ...
                    $total_shipping_cost = $shipping_cost * $total_quantity;

                     $grand_total = $total_price_after_discount + $total_shipping_cost; //grand total including shipping cost

            $total_shipping_cost = ($total_shipping_cost)?'Shipping Cost : '."&#8358; ". number_format($total_shipping_cost, 2).'<br />':'';
                    

                    ?>
                    <tr>
                        <td colspan="3" align="right">Coupon Discount:<input
                    ...
                    <tr>
                        ...
                        <td align="right" colspan="2"><strong><?php echo $total_shipping_cost; ?>Amount Payable : <?php echo number_format ($grand_total, 2);?></td>
                        <td></td>
                    </tr>
